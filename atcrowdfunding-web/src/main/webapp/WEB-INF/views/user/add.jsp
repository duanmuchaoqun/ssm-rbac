                        ...
                        <div class="form-group">
                            <span>
                                ...
                                <input type="text" class="form-control" name="account" id="account"
                                       datatype="/^[a-zA-Z0-9_-]{5,16}$/"
                                       nullmsg="请输入登录账号！" errormsg="登陆账号为5-16位英文字母、数字、下划线的组合！" placeholder="请输入登陆账号">
                            </span>
                            <span></span>
                        </div>
                        <div class="form-group">
                            <span>
                                ...
                                <input type="text" class="form-control" name="username" id="username"
                                       datatype="/(^[a-zA-Z0-9_-]{5,16}$)/"
                                       nullmsg="请输入用户名称！" errormsg="用户名称5-16位英文字母、数字、下划线的组合！" placeholder="请输入用户名称">
                            </span>
                            <span></span>
                        </div>
                        <div class="form-group">
                            <span>
                                ...
                                <input type="email" class="form-control" name="email" id="email" datatype="e"
                                       ...
                                       placeholder="请输入邮箱地址,格式为： xxxx@xxxx.com">
                            </span>
                            <span></span>
                        </div>
